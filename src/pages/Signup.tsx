...
import { Eye, EyeOff, Mail, Lock, User, ArrowRight, Briefcase, Coins, GraduationCap, Loader2 } from "lucide-react";
...
const Signup = () => {
  ...
  const { signUp, signInWithGoogle, isSupabaseEnabled } = useAuth();
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="glass-card rounded-3xl p-8 shadow-xl">
          ...
          <Button 
            ...
            onClick={async () => {
              if (!isSupabaseEnabled) {
                toast.error("Google sign-in requires cloud connection.");
                return;
              }
